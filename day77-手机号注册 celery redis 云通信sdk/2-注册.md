...
注册页面Register,主要是通过登录页面进行改成而成（components/Register.vue）
...
后端视图提供注册功能的api接口，user/views.py增加视图代码：
...
![image-20191126205335447](E:\上课内容\4-路飞学城\day77\2-注册.assets\image-20191126205335447.png)
