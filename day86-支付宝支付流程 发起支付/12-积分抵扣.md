...
class OrderModelSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        # 判断优惠券是都已经使用或者在使用时间范围内
        now_time = datetime.now()
        try:
            if coupon != 0:
                UserCoupon.objects.filter(coupon=coupon, is_show=True, is_deleted=False, is_use=False, start_time__lte=now_time,
